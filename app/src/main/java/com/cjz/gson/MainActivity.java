...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //    private String weatherApi = "http://guolin.tech/api/weather?cityid=CN101281701&key=00d6c3f6c9994cc1ae92d054f77828c0";//完整请求路径(例子)
    private String weatherUrl = "http://guolin.tech/api/weather?cityid=%s&key=%s";
    private String weatherUrl2 = "https://free-api.heweather.net/s6/weather/now?location=%s&key=%s";
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    //拼接字符串
                    String weatherApi = String.format(weatherUrl2, cityId, key);
